...
const DRIVE_FOLDER_STUDENT_PROFILES = "1jirQllJiSalmrNvo74MOnJtIc7Yab1SZ";  // รูปโปรไฟล์/รูปบ้านนักเรียน
const DRIVE_FOLDER_HOME_VISIT = "1FmzVvVigd6NMyK5uPd9xccTVK1MPYWQA";        // รูปการเยี่ยมบ้าน
const DRIVE_FOLDER_ASSIGNMENTS = "1uAtXPdUaCgMbNjL9_qSIBXz02iqj6ABJ";       // งานครู/สื่อการสอน
const DRIVE_FOLDER_SUBMISSIONS = "1dIYBgcn_fxS2KX6wTZKmwdq8moVlZUnA";       // งานนักเรียนที่ส่งมา
const DRIVE_FOLDER_PR_NEWS = "1SipiPR7sFBwVCjLadCd9ylbh1mPZ97cz";           // รูปประชาสัมพันธ์
